/**
  ...
  *              - To use or not the peripheral锟絪 drivers in application code(i.e. 
  *                code will be based on direct access to peripheral锟絪 registers 
  ...
  *           - Macros to access peripheral锟絪 registers hardware
  *
  ******************************************************************************
  * @attention
  *
